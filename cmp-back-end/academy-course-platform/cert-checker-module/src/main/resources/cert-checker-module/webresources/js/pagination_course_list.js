$(document).ready(function () {
    ...
    const pagination = {
        current: parseInt(courseListCurrentPage),
        total: parseInt(courseListTotalPage),
        data: '',
        dots: `<li>...</li>`,
    };
    ...
    const clickItem = e => {
        ...
        window.location.href = decodeURI(path + '?category=' + currentCategory + '&pageNumber=' + pagination.current);
    };
