...
This package contains:
   ...
   Magnolia Core 6.1.1
   magnolia-empty-webapp 6.1.1
   magnolia-empty-webapp 6.1.1
   Magnolia Internationalization Framework 6.1.1
   Magnolia JAAS 6.1.1
   Magnolia Mail module 5.5.2
   magnolia-module-rssaggregator 2.6.2
   Magnolia Rendering 6.1.1
   Magnolia Templating 6.1.1
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.1.1.html
